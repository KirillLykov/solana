//! New client optimized for bench-tps requirements:
//! * hight as possible mean TPS
//! * low std TPS
//! To achieve this we do the following:
//! * optimize the size of send batch
//! * send batches using connection cache in nonblocking fashion
//! * use several staked connection caches
//! * use leader cache from TpuClient
//!
use {
    ...
    solana_sdk::{
        ...
        feature_set::add_set_tx_loaded_accounts_data_size_instruction, hash::Hash,
