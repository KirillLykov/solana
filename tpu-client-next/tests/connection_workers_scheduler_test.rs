...
async fn test_no_host() {
    ...
    let SpawnTransactionGenerator {
        ...
        transaction_sender_done,
        ..
    } = spawn_transaction_sender(transaction_size, max_send_attempts, Duration::from_millis(10));
...
async fn test_update_identity() {
    ...
    let SpawnTransactionGenerator {
        ...
        transaction_sender_shutdown,
        ..
    } = spawn_transaction_sender(transaction_size, num_transactions, Duration::from_millis(50));
